...
QUnit.test("Count Values", function (assert) {
    ...
    assert.deepEqual(countValues([1, 99, 43, 2, 55, 78, 99, 2345, 438, 2, 99, 107]),
...
QUnit.test("Filter Evens", function (assert) {
    ...
    assert.deepEqual(filterEvens([2, 4, 6]), [2, 4, 6]);
    assert.deepEqual(filterEvens([100, 8, 21, 24, 62, 9, 7]), [100, 8, 24, 62]);
        
});

QUnit.test("Filter Numbers Bigger Than 100", function (assert) { 

    assert.deepEqual(filterBigNumbers([7, 10, 121, 100, 24, 162, 200]), [121, 100, 162, 200]);
...
QUnit.test("Filter Multiples of X", function(assert) { 
    ...
    assert.deepEqual(filterMultiplesOfX([3, 5, 1, 9, 18, 21, 42, 67], 3), [3, 9, 18, 21, 42]);
    assert.deepEqual(filterMultiplesOfX([3, 5, 10, 20, 18, 21, 42, 67], 5), [5, 10, 20]);
...
QUnit.test("Create Object", function(assert) { 
    ...
    assert.notEqual(result.firstName, undefined, "Object needs a firstName property");
    assert.notEqual(result.lastName, undefined, "Object needs a lastName property");
    assert.notEqual(result.age, undefined, "Object needs an age property");
