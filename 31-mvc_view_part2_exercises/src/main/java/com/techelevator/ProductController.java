...
public class ProductController {
	...
	public String showProductList(ModelMap modelHolder) {
		modelHolder.put("productList", getProducts());
		return "productList";
	}
	
	@RequestMapping(path="/productTiles")
	public String showProductTiles(ModelMap modelHolder) {
		modelHolder.put("productList", getProducts());
		return "productTiles";
	}
	
	@RequestMapping(path="/productTable")
	public String showProductTable(ModelMap modelHolder) {
		modelHolder.put("productList", getProducts());
		return "productTable";
	}
	
	@RequestMapping(path="/productDetail")
	public String showProductDetail(ModelMap modelHolder, @RequestParam String productId) {
